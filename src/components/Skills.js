...
const Skills = () => {
  return ( 
    <>
        ...
        <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]  dark:text-dark dark:bg-light
        ...
        '>
                ...
                <Skill name="Firebase" x="-22vw" y="17vw" />
