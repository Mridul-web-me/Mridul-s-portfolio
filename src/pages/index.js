      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light 2xl:">
        <Layout className="pt-0 md:p-16 sm:pt-8">
          ...
          50vw"
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link className="ml-4 text-lg font-medium capitalize text-dark underline dark:text-light md:text-base " href="mailto:md.mridul.23@gmail.com" target={'_blank'}>
                  Contact
                </Link>
              </div>
            </div>
